  ...
  { -- Highlight, edit, and navigate code
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>bt', function()
        ...
        print("TS: filetype: " .. filetype .. ", hl-active: " .. tostring(highlighting_active) .. ", parser: " .. tostring(parser_path_results[1]))
      ...
      require'nvim-treesitter.configs'.setup({
        textobjects = {
          ...
          move = {
            ...
            set_jumps = true,
            goto_next_start = {
              ["]f"] = { query = "@function.outer", desc = "Next [f]unction/method start" },
              ["]c"] = { query = "@class.outer",    desc = "Next [c]lass start" },
            },
            goto_next_end = {
              ["]F"] = { query = "@function.outer", desc = "Next [F]unction/method end" },
              ["]C"] = { query = "@class.outer",    desc = "Next [C]lass end" },
            },
            goto_previous_start = {
              ["[f"] = { query = "@function.outer", desc = "Previous [f]unction/method start" },
              ["[c"] = { query = "@class.outer",    desc = "Previous [c]lass start" },
            },
            goto_previous_end = {
              ["[F"] = { query = "@function.outer", desc = "Previous [F]unction/method end" },
