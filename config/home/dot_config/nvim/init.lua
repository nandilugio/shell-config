...
-- Local plugins. Structured as ones so they can move to their own repos
-- unchanged, which is why the filetype list is passed in rather than assumed:
-- vimwiki is markdown to treesitter but is written rather than read, and
-- inline padding shifts the real columns. mdheading takes the same list for
-- consistency, though its colouring would be harmless in notes.
